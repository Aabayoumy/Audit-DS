...
Export-ModuleMember -Function Export-NTLMEvents, Export-LDAPEvents, Export-ADInfo, Export-UserSecurity, Get-DCs, Export-AdminUsers, Enable-Audit, Export-ComputersOS, Set-LogSize, Get-LdapServerCertificate, Install-PingCastle, Start-PingCastle, Export-RC4Tickets, Export-Assesment
